...
class Clause extends \yii\db\ActiveRecord
{
    ...
    {
        $averageStatus = $this->subclauses_average_status = floatval($this->getSubClauses()->average('average_status')) ?: 0.00;
        return Yii::$app->formatter->asDecimal($averageStatus, 2);
    }
